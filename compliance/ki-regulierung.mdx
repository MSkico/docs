...
Obwohl der EU AI Act bereits im Sommer 2024 inkraftgetreten ist, erfolgt die Umsetzung über einen mehrjährigen Zeitraum. Ab 
August 2026 gilt dann der volle Umfang des EU AI Act in allen EU-Mitgliedstaaten. 
...
| Gewährleistung der Robustheit, Genauigkeit, Sicherheit | bis 31.12.25    | 02.08.2026      |
| Monitoring von Sicherheits- und Robustheitsmetriken    | ✅                | 02.08.2026      |
| Logging von Systementscheidungen und -vorfällen        | bis 31.12.25      | 02.08.2026      |
...
| Konformitätserklärung                                  | bis 31.12.25      | —               |
| CE-Kennzeichnung                                       | bis 31.12.25      | —               |
...
Die Konformitätserklärung und CE-Kennzeichnung wird vorgenommen. Eine Registrierung in der dafür vorgesehenen EU-Datenbank wird durchgeführt, sobald diese verfügbar ist.
...
<AccordionGroup>
  ...
  <Accordion title="Welche KI-Systeme nutzt skillconomy und wie sind sie eingestuft?">
    Wir nutzen mehrere KI-Systeme, z.B. zur **Erstellung von Longlists** (hochriskant) oder zur **Erfassung von Stellenanzeigen** (minimales Risiko).  
    Nur das Longlisting-System fällt in die Hochrisiko-Kategorie gem. EU AI Act.
  </Accordion>
  ...
  <Accordion title="Ab wann gilt der EU AI Act vollständig?">
    ...
    Die vollständige Umsetzung mit allen Pflichten erfolgt bis **2. August 2026**.  
